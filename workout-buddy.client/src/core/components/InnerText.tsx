import {Box, Heading, Text, Card, Button, useColorModeValue } from "@chakra-ui/react";
    ...
    return (
        <Card color={"lightPallette.background.main"} position="absolute" w="100%" height="100%" bg="rgba(0,0,0,0.5)">
            <Box width="75%" mx="auto" mt="100px" height="75%">
                ...
                <Button mt="50px" colorScheme={useColorModeValue("lightPallette.primary", "darkPallette.primary")}>
                    <Link to="/register">
                        Get Started
                    </Link>
                </Button>
